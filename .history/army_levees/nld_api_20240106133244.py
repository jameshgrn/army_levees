...
gdf = gpd.GeoDataFrame.from_features(get_request(geojson_download_url), crs='EPSG:4326')
...
url = 'https://levees.sec.usace.army.mil:443/api-local/system/1705000441/profile'
