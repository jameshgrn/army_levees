...
profile_gdf = gpd.GeoDataFrame([{'geometry': geometry}], crs='EPSG:4269')
# Check the original data's bounds
# Make sure the CRS is set correctly for the original data
profile_gdf.crs = "EPSG:4269"  # Set the CRS to NAD83 if it's not already set

# Attempt reprojection again
...
for geom in profile_gdf.geometry:
